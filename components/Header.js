...
export default function Header() {
    ...
    return (
        <header className="flex items-center sticky top-0 z-50 px-4 py-2 shadow-md bg-white" >
            ...
            <div className="flex flex-grow items-center px-5 py-2 bg-gray-100 text-gray-600 mx-5 md:mx-20 focus-within:shadow-md " >
            ...
            <img loading="lazy" onClick={signOut} className="h-12 w-12 rounded-full ml-2 cursor-pointer" src={session?.user?.image} alt="" />
